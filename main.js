            ...
            documentDropdown.onchange = function() {
                ...
                documentDisplay.innerHTML = `
                    <div class="document-content">
                        ...
                        <p><strong>Containment Procedures:</strong> ${doc.containmentProcedures ? doc.containmentProcedures : (doc.reportSummary ? doc.reportSummary : (doc.profile ? doc.profile : (doc.background ? doc.background : 'N/A')))}</p>
                        <p><strong>Description:</strong> ${doc.description ? doc.description : (doc.details ? doc.details : (doc.currentActivities ? doc.currentActivities : (doc.evidence ? doc.evidence : (doc.analysis ? doc.analysis : (doc.operationDetails ? doc.operationDetails : (doc.rehabilitationProtocol ? doc.rehabilitationProtocol : 'N/A'))))))}</p>
