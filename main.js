            ...
            documentDropdown.onchange = function() {
                ...
                documentDisplay.innerHTML = `
                    <div class="document-content">
                        ...
                        <p><strong>Containment Procedures:</strong> ${doc.containmentProcedures ? doc.containmentProcedures : (doc.reportSummary ? doc.reportSummary : 'N/A')}</p>
                        <p><strong>Description:</strong> ${doc.description ? doc.description : (doc.details ? doc.details : 'N/A')}</p>
